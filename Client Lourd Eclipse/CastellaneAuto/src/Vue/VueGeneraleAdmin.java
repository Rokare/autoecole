...
public class VueGeneraleAdmin extends JFrame implements ActionListener {
	private JPanel panelMenu = new JPanel();
	private JButton tabButtons [] = new JButton[4];
	private String tab[] = {"Gestion Candidats", "Gestion Moniteurs","Gestion Personnel", "Gestion Planning"};
	...
	public VueGeneraleAdmin() {
		...
		this.panelMenu.setLayout(new GridLayout(1, 4));  //une ligne compos� de 4 cases
