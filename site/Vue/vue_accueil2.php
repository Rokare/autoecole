   <main role="main">
          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-lg btn-primary" href="indexTiers.php?p=4" role="button">Planning</a></p>
              </div>
            </div>
          </div>
          <div class="carousel-item">
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">Qui sommes nous ? <span class="text-muted">Auto-Ecole Castellane</span></h2>
            <p class="lead">Auto Ecole Castellane est un acteur incontournable sur le marché de l’apprentissage de la conduite Auto- Moto depuis 1986 et connu grâce à son taux de réussite élévé aux examens.
...
Nos équipes pédagogiques compétentes et sympathiques mettront tout en œuvre pour satisfaire vos obligations, vous aider à préparer vos projets et conduire un véhicule de façon autonome et apaisé.</p>
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2">
            <h2 class="featurette-heading">Plus facile et plus rapide <span class="text-muted">Plus de déplacement inutile</span></h2>
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">VOUS ÊTES UN APPRENTI ? <span class="text-muted">Pas de problème</span></h2>
